 ...
 * Created by Redpike
 */
public class UzytkownikView extends AbstractView<UzytkownikPresenter> {

    private UzytkownikPresenter uzytkownikPresenter;
    private UzytkownikPage uzytkownikPage;
    ...
    private void addListeners() {
        crudButtonLayout.getAddButton().addClickListener(clickEvent -> {
            uzytkownikAddEditWindow = new UzytkownikAddEditWindow(uzytkownikPage);
        ...
        crudButtonLayout.getDeleteButton().addClickListener(clickEvent -> {
            ...
            ConfirmDialog.show(getUI(), "Usuwanie użytkownika", "Czy na pewno chcesz usunąć użytkownika " + uzytkownik.getNazwa(), "Tak", "Anuluj", confirmDialog -> {
                if (confirmDialog.isConfirmed()) {
                    uzytkownikPage.getUzytkownikPresenter().removeUzytkownik(uzytkownik);
                    refreshTable();
    ...
    public void refreshTable() {
        ...
        table.setBeans(uzytkownikPage.getUzytkownikPresenter().getAllUzytkownicy());
    }
