 ...
 * Created by Redpike
 */
public class KlientPropertyUtil {
    ...
    public static final String MODULO_HEADER = "Modulo";
    public static final String PESEL_HEADER = "PESEL";
    public static final String REGON_HEADER = "REGON";
